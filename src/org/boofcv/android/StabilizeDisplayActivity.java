...
implements CompoundButton.OnCheckedChangeListener
{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		RadioButton seek = (RadioButton)controls.findViewById(R.id.radio_features);
	...
	protected class PointProcessing extends BoofRenderProcessing {
		...
		ImageDistort<ImageUInt8> distorter;
		...
		public PointProcessing( StitchingFromMotion2D<ImageUInt8,Affine2D_F64> alg  ) {
			...
			InterpolatePixel<ImageUInt8> interp = FactoryInterpolation.createPixel(0, 255, TypeInterpolate.BILINEAR, ImageUInt8.class);
			distorter = FactoryDistort.distort(interp, null, ImageUInt8.class);
		}
